# Generated by Django 4.2.4 on 2024-05-16 04:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "alternate_name",
                    models.CharField(blank=True, max_length=100, verbose_name="又名"),
                ),
                (
                    "image_url",
                    models.CharField(blank=True, max_length=300, verbose_name="图片链接"),
                ),
                ...
                (
                    "quality",
                    models.SmallIntegerField(
                        choices=[(1, "720P"), (2, "1080P"), (3, "4K")],
                        verbose_name="清晰度",
                    ),
                ),
                (
                    "subtitle",
                    models.CharField(blank=True, max_length=100, verbose_name="字幕"),
                ),
                (
                    "update_info",
                    models.CharField(blank=True, max_length=100, verbose_name="更新信息"),
                ),
                (
                    "update_progress",
                    models.CharField(blank=True, max_length=100, verbose_name="更新进度"),
                ),
                (
                    "download_info",
                    models.TextField(
